  ...
  namespace VintageAsset
  {
    ...
    public sealed class VintageCGAEditor : VintageEditorBase
    {
      ...
      protected override void Inspector()
      {
        ...
        thisTarget.Palette = (VintageCGA.Palettes)EditorHelper.EnumPopup(@"Palette", thisTarget.Palette, VintageCGA.Palettes.One);

        thisTarget.PixelSize = EditorHelper.IntSlider(@"Pixel size", thisTarget.PixelSize, 1, 25, 4);
