...
namespace Ibuprogames
{
  ...
  {
    /// <summary>
    /// Rise gives your game a nice glow and warmth by adding yellow tones.
    /// </summary>
    [ExecuteInEditMode]
    [RequireComponent(typeof(Camera))]
    [AddComponentMenu("Image Effects/Ibuprogrames/Vintage/Vintage Rise")]
    public sealed class VintageRise : VintageBase
    {
      #region Properties.
      /// <summary>
      ...
      {
        return @"Rise gives your game a nice glow and warmth by adding yellow tones.";
      }
      ...
      protected override void LoadCustomResources()
      {
        ...
        levelsTex = LoadTextureFromResources(@"Textures/riseMap");
      }
