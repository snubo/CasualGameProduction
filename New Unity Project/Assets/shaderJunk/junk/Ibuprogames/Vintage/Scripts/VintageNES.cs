...
namespace Ibuprogames
{
  namespace VintageAsset
  {
    ...
    [AddComponentMenu("Image Effects/Ibuprogrames/Vintage/Vintage NES")]
    public sealed class VintageNES : VintageBase
    {
      #region Properties.
      /// <summary>
      ...
      {
        return @"Simulates NES using DawnBringer's palettes plus dithering.";
      }
