...
/// Vintage Hudson.
/// </summary>
Shader "Hidden/Vintage/VintageHudson"
{
  Properties
  {
  ...
  {
    pixel = PixelBlowoutOverlayStrength(_BlowoutTex, _OverlayTex, uv, pixel, _OverlayStrength);

    return PixelLevels(_LevelsTex, pixel);
  }
